...
export const createUser = async (req, res, next) => {
    try {
        ...
        const result = await pool.query('INSERT INTO users (name, username, password, role, phone) VALUES ($1, $2, $3, \'cashier\', $4) RETURNING id, name, username, role, phone, is_active, created_at', [name, username, hashedPassword, phone]);
