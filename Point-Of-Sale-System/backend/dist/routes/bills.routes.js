...
const billsController = __importStar(require("../controllers/bills.controller.js"));
...
router.put('/:id/cancel', (0, roleGuard_js_1.roleGuard)(['owner']), billsController.cancelBill);
