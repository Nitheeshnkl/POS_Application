...
const purchasesController = __importStar(require("../controllers/purchases.controller.js"));
const auth_js_1 = require("../middleware/auth.js");
const roleGuard_js_1 = require("../middleware/roleGuard.js");
const router = (0, express_1.Router)();
router.use(auth_js_1.authenticate);
router.get('/', purchasesController.getAllPurchases);
router.post('/', (0, roleGuard_js_1.roleGuard)(['owner']), purchasesController.createPurchase);
