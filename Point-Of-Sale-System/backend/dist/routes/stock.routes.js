...
router.post('/adjust', (0, roleGuard_js_1.roleGuard)(['owner']), stockController.adjustStock);
router.post('/mark-damaged', (0, roleGuard_js_1.roleGuard)(['owner']), stockController.markDamaged);
